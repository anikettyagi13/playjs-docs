...
//   rotateZ: 30,
// });
const timelined = anime.timeline({
  duration: 750,
})
// timelined.add({
//   targets: ".helo",
...
//     {
//       value:
//         "M92 60.5C92 121 100.346 121 65.0001 121C29.6539 121 0 93.9132 0 60.5C0 27.0868 29.6539 0 65.0001 0C100.346 0 92 0 92 60.5Z",
//     },
//   ],
// });

timelined.add({
  targets: '#loading_path',
  d: [
    {
      value:
        'M414 187C414 290.277 321.323 374 207 374C92.6771 374 0 290.277 0 187C0 83.7228 92.6771 0 207 0C321.323 0 414 83.7228 414 187ZM67.166 187C67.166 256.767 129.772 313.323 207 313.323C284.228 313.323 346.834 256.767 346.834 187C346.834 117.233 284.228 60.6766 207 60.6766C129.772 60.6766 67.166 117.233 67.166 187Z',
    },
  ],
})
